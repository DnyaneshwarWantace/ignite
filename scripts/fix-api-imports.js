...
const videoChanges = processDirectory('src/app/api/editor/video', 'video');
console.log(`✓ Updated ${videoChanges} files in video editor API`);

const imageChanges = processDirectory('src/app/api/editor/image', 'image');
console.log(`✓ Updated ${imageChanges} files in image editor API`);

console.log(`\n✅ Total: ${videoChanges + imageChanges} API files updated`);
