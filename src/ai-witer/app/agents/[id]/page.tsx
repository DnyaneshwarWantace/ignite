...
export default function AgentPage() {
  ...
  const loadDNAs = async () => {
    try {
      ...
      alert("Failed to load DNAs. Please check your Supabase connection.");
    }
  };
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (selectedDNA) {
        ...
        if (!error && sectionsData) {
          ...
          sectionsData.forEach((section: any) => {
            ...
            // Track sections that have content
      ...
      // Auto-save generated response to history
      ...
      // Also save to a list of all responses for this agent
      const allResponses = JSON.parse(localStorage.getItem(`agent-responses-${agentId}`) || "[]");
      allResponses.push(responseData);
      localStorage.setItem(`agent-responses-${agentId}`, JSON.stringify(allResponses));
    } catch (error: any) {
