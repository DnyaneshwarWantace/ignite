...
export async function POST(request: NextRequest) {
  try {
    ...
    const remotionCommand = `npx remotion render src/editor/src/remotion/entry.tsx VideoComposition ${outputPath} --props=${tempDataPath} --fps=30 --width=${platformConfig.width} --height=${platformConfig.height} --concurrency=8 --jpeg-quality=80`;
