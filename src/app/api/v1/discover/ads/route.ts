...
async function handleDiscoverAds(request: NextRequest, user: User) {
  ...
  // Import Prisma dynamically only during runtime
...
export const GET = authMiddleware(
  async (request: NextRequest, context: any, user: User) => {
    try {
      return await handleDiscoverAds(request, user);
    } catch (error) {
