...
export default function ImageEditorPage() {
  ...
  const loadProjects = async () => {
    try {
      ...
      const response = await fetch('/api/editor/image/projects', {
  ...
  const duplicateProject = async (projectId: string) => {
    try {
      const response = await fetch(`/api/editor/image/projects/${projectId}/duplicate`, {
        method: 'POST',
      });
  ...
  const renameProject = async () => {
    ...
    try {
      const response = await fetch(`/api/editor/image/projects/${selectedProject.id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
