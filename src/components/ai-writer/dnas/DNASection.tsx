...
import Card from "@/components/ai-writer/ui/Card";
          ...
          <div className="text-sm text-gray-700 pt-4">
            ...
            {agent && (
              <p className="mt-2">
                ...
                <Link href={getAgentUrl(agent, id)} className="text-gray-900 underline hover:text-gray-700">
                  {agent}
                </Link>
              </p>
            )}
            {agents && agents.length > 0 && (
              <p className="mt-2">
                ...
                {agents.map((agentName, index) => (
                  <span key={index}>
                    <Link href={getAgentUrl(agentName, id)} className="text-gray-900 underline hover:text-gray-700">
                      {agentName}
                    </Link>
