    ...
    <div className="relative">
      ...
      <div className="absolute top-2 right-2 flex items-center gap-3">
        <div className="flex flex-col items-end text-xs">
          ...
          {limitByWords && <span className="text-gray-400">{charCount.toLocaleString()} chars</span>}
        </div>
        <button type="button" className="p-1.5 text-gray-400 hover:text-gray-600 transition-colors" title="Voice input">
