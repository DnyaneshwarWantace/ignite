      ...
      <div className="relative" ref={selectRef}>
        <button
          ...
          className={cn(
            ...
            "flex items-center justify-between text-left text-sm text-gray-900",
            "hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-colors"
          )}
        >
