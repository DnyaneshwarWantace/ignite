		...
		<div className="flex gap-2 py-0 flex-col lg:flex-row">
			...
			{isLargeScreen ? (
				...
				<div className="w-full">
					<ScrollArea className="h-[300px] w-full py-0 max-h-[40vh] overflow-hidden">
						<div className="grid gap-4 [grid-template-columns:repeat(auto-fit,minmax(100px,1fr))] p-2">
							<div
