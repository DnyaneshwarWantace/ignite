...
export const BriefSchema = z.object({
  ...
  productDescription: z.string().max(1200, { message: "Description must be 1200 characters or less." }),
  usp: z.string().max(1200, { message: "USP must be 1200 characters or less." }),
